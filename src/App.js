...
const App = () => {
  ...
  return (
    <div className='wrapper'>
      <StoreApi.Provider value={{ onSubmit, login, setLogin, email, setEmail, password, setPassword, error, setError, data, setData, personsInfo, setPersonsInfo, cases, setCases }}>
